  ...
  return(
    <div className="parent">
      {jobOpenings.map(function(elem, idx){
        return <div key={idx}>
          <Card companyName={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} location={elem.location} brandLogo={elem.brandLogo} pay={elem.pay} tag2={elem.tag2} />
        </div>
      })}
    </div>
  )
